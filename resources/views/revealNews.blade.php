...
<p>{{$news->name}}</p>
<p>{{substr($news->date_create, 0,10)}}</p>
...
@foreach ($comments as $comment)
    <div class="comment">
        ...
        <a href="../comments/remove/{{$comment->id}}?type=news">
...
@endforeach
    ...
    <form  action="../{{$news->id}}/addComment" method="post" class="col-md-5">
            @csrf 
            ...
            <input required type="hidden" name="type" value="news">

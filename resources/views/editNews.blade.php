    ...
    <main>
        ...
        @csrf
            <div class="form-group mt-3">
                <label for="heading">Название новости</label>
                <input  id="heading" name="heading" type="text" class="form-control" value="{{$news->heading}}">
            </div>
            ...
            <div class="form-group ">
                ...
                <input  id="name" name="name" type="text" class="form-control" value="{{$news->name}}">
            </div>

            <div class="form-group mt-3">
                <label for="date_create">Дата</label>
                <input id="date_create" name="date_create"  type="date"  class="form-control" value="{{substr($news->date_create, 0,10)}}">
            </div>
